...
Using For loop to create 4 data.frame and ggplot save as plot_i then combine plot with patchwork library and also adding main title and caption
```{r}
############ For loop
